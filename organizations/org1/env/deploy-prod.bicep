...
// Load KQL files
var kqlEncoded = loadTextContent('./kql/prod/uc-powershell-encoded.kql')
var kqlLogin = loadTextContent('./kql/prod/suspicious-login-attempts.kql')
var kqlAdmin = loadTextContent('./kql/prod/admin-account-anomaly.kql')
